...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px] focus-visible:ring-[#94A3B8] focus-visible:ring-offset-1",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        lg: 'h-11 rounded-[10px] px-5 has-[>svg]:px-4 text-[15px] font-medium',
